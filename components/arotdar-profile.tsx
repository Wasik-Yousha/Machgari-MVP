...
export function ArotdarProfile({ user }: ArotdarProfileProps) {
  return (
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
          ...
          <div>
            <p className="text-gray-500 dark:text-gray-400 text-sm">দোকানের নাম</p>
            <p className="font-medium">{user.shopName}</p>
          </div>
          <div>
            <p className="text-gray-500 dark:text-gray-400 text-sm">লাইসেন্স</p>
          ...
          <div className="md:col-span-2">
            <p className="text-gray-500 dark:text-gray-400 text-sm">মোট ক্রয়</p>
            <p className="font-medium text-lg text-primary">{user.totalPurchase}</p>
          </div>
        </div>
      </div>
    </div>
